 ...
 * @author federico
 */
public class AnalisisExperimentos extends javax.swing.JFrame {

    /**
     * Creates new form AnalisisExperimentos
     */
    public AnalisisExperimentos() {
        initComponents();
        
        for (Investigador inv: Ejemplo_Proyecto.lista_investigador) {
            comboInvestigador.addItem(inv.codigo);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Analisis de Experimentos");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(comboInvestigador, 0, 248, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnalisisExperimentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnalisisExperimentos().setVisible(true);
            }
        });
    }
